...
// CSS
//       .($hq ? ' style="image-rendering:optimizeQuality"' : ' style="image-rendering:optimizeSpeed"')
       .' alt=""'
       .' border="0"'
...
function
widget_video_juzp ($video_url, $width=450, $height=370, $autoplay = 0, $hq = 0, $loop = 0)
{
/*
		<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/...version=5,0,0,0" width="400" height="59" id="swf">
                              <param name="wmode" value="transparent" />
                              <param name=movie value="http://net.juzp.net/hZGAZhfgszur-:true.v" />
                              <param name=quality value=high />
                              <embed src="http://net.juzp.net/hZGAZhfgszur-:true.v" quality=high pluginspage="http://www.macromedia.com/shockwave...=ShockwaveFlash" type="application/x-shockwave-flash" width="400" height="59" wmode=transparent id="swf"> </embed>

 </object>	
*/
  $url = str_replace ('www.juzp.net', 'net.juzp.net', $video_url).':true.v';
  $o = array (
    array ('width', $width),
    array ('height', $height),
  );
