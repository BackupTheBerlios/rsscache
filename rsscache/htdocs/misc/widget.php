  ...
  while (($file = readdir ($dir)) != false)
    {
      if (is_dir ($file))
        {
          $p .= '<img src="images/file_tree_closed.png" border="0" alt="images/file_tree_open.png">'
                 .basename ($file);
        }
      else if (is_file ($file))
        {
          $stat = stat ($file);
          $p .= '<img src="images/file_tree_file.png" border="0" alt="images/file_tree_file.png">'
               .basename ($file)
               .$stat['size'];
        }
      else // ?
