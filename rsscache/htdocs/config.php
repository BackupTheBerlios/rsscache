...
$tv2_title = 'lifestyle';
$tv2_body_tag = '<body>';
$tv2_logo = 'lifestyle <img src="http://plugins.pwnoogle.com/qrcode.php?data=http://lifestyle.pwnoogle.com&size=2" style="vertical-align:top;">';
$tv2_videos_s = 'items';
$tv2_related_s = 'Find related '.$tv2_videos_s;
$tv2_default_category = '';  // default category
$tv2_collapsed = 0;   // collapse categories
$tv2_config_xml = 'config.xml';
$tv2_include_php = 'tv2_include.php';
$tv2_thumbnails_prefix = '';


$tv2_root = dirname(__FILE__).'/';
$tv2_rss_head = 1;
$tv2_link = 'http://lifestyle.a1.25u.com/';
$tv2_link_static = 'http://lifestyle.a1.25u.com/'; // remote static content
...
$tv2_config_xml = 'lifestyle_config.xml';
$tv2_include_php = 'tv2_include.php';
$tv2_thumbnails_prefix = '';

$tv2_title = 'lifestyle - pwnoogle \:D/';
$tv2_logo = 'lifestyle <img src="http://plugins.pwnoogle.com/qrcode.php?data=http://lifestyle.pwnoogle.com&size=2" style="vertical-align:top;">';

$tv2_link = 'http://lifestyle.pwnoogle.com/';
$tv2_link_static = 'http://lifestyle.pwnoogle.com/'; // remote static content
$tv2_debug_sql = 0;
$tv2_enable_search = 1; // allow users to search db?
$tv2_collapsed = 2; // collapse categories? 0 == no, 1 == yes, 2 == never
